...
public:
    ...
    // Command pattern interface methods
    void SetMoveUp(bool value) { isUp = value; }
    void SetMoveDown(bool value) { isDown = value; }
    void SetMoveLeft(bool value) { isLeft = value; }
    void SetMoveRight(bool value) { isRight = value; }
    void SetJump(bool value) { isJumpButton = value; }
    void SetRoll(bool value) { isRollButton = value; }
    void SetAim(bool value) { isAimButton = value; }
    
    // Getter methods for command pattern
    bool GetIsAiming() const { return isAiming; }
    
    // Reset movement flags (called before processing input each frame)
